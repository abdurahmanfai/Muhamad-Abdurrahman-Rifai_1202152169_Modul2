                ...
                public void onClick(View view) {
                    ...
                    switch (getAdapterPosition()){
                        case 0 :
                            ...
                            ingredient = "Nasi,Sambal,Telur,Ayam Goreng";
                        ...
                        case 3 :
                            ...
                            intent.putExtra("harga",rvHarga.get(getAdapterPosition()));
                            intent.putExtra("gambar",gambar.get(getAdapterPosition()));
                            ingredient = "Bakso, Mie, Sambal, Sayur";
                            intent.putExtra("komposisi",ingredient);
                            context.startActivity(intent);
                            break;
                        case 4 :
                            ...
                            intent.putExtra("harga",rvHarga.get(getAdapterPosition()));
                            intent.putExtra("gambar",gambar.get(getAdapterPosition()));
                            ingredient = "Mie, Telor, Sosis, Bakso";
                            intent.putExtra("komposisi",ingredient);
                            context.startActivity(intent);
                            break;
                        case 5 :
                            ...
                            intent.putExtra("harga",rvHarga.get(getAdapterPosition()));
                            intent.putExtra("gambar",gambar.get(getAdapterPosition()));
                            ingredient = "Ayam, Bihun, Sayur, Bawang, Sambal";
                            intent.putExtra("komposisi",ingredient);
                            context.startActivity(intent);
                            break;
                        case 6 :
                        ...
                        case 8 :
                            ...
                            intent.putExtra("harga",rvHarga.get(getAdapterPosition()));
                            intent.putExtra("gambar",gambar.get(getAdapterPosition()));
                            ingredient = "Lele, Lalaban, Sambal";
                            intent.putExtra("komposisi",ingredient);
                            context.startActivity(intent);
                            break;
                        ...
                        case 10 :
                            ...
                            intent.putExtra("harga",rvHarga.get(getAdapterPosition()));
                            intent.putExtra("gambar",gambar.get(getAdapterPosition()));
                            ingredient = "Ayam, Kecap, Sambal, Lalapan";
                            intent.putExtra("komposisi",ingredient);
                            context.startActivity(intent);
                            break;
                    }
