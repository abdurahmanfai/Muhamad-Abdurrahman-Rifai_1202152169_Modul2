...
public class ListPesanan extends AppCompatActivity {
    ...
    //Daftar Menu Makanan
    private String[] Judul = {"Nasi Goreng Ayam", "Sate Ayam","Bakso Telor","Mie Goreng Spesial","Soto Betawi","Lele Asam",
            "Cah Kangkung","Pecel Lele","Nasi Pecel","Ayam Bakar"};
    //Daftar Harga
    private String[] test = {"Rp. 30.000", "Rp. 20.000","Rp. 15.000","Rp. 20.000","Rp. 15.000","Rp. 20.000","Rp. 15.000","Rp. 15.000",
            "Rp. 15.000","Rp. 15.000"};
    //Daftar Gambar
    private int[] Gambar = {R.drawable.nasigoreng, R.drawable.sate,R.drawable.bakso,R.drawable.miegoreng,R.drawable.soto,
            R.drawable.leleasam,R.drawable.kangkung,R.drawable.pecelele,R.drawable.nasipecel,R.drawable.ayambakar};
